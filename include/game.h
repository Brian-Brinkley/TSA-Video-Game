...
private:
    ...
    std::vector<Rectangle> level2Collisions = {
        ...
        {zoom * 15, zoom * 568, zoom * 147, zoom * 50},
        {zoom * 162, zoom * 600, zoom * 160, zoom * 18},
        ...
        {zoom * 431, zoom * 248, zoom * 146, zoom * 83},
        ...
        {zoom * 241, zoom * 248, zoom * 178, zoom * 19},
        ...
        {zoom * 431, zoom * 408, zoom * 18, zoom * 95},
        ...
        {zoom * 879, zoom *  408, zoom * 34, zoom * 15},
